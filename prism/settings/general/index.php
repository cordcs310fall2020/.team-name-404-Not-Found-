	...
	<div id = "content">
		...
		<div id = "main-content">
			<form id="form1" name="form1" enctype="multipart/form-data" action="" method="POST">
				...
				<hr><br/>
				<label id="textbox1label" class="contact_form_label" name="textbox1label" for="name">Name:</label>
				<input type="text" id="name" name="name">
				<button id="editname" class="form_button" name="editname" value="editname">Edit</button>
				<br/><br/>

				<label id="textbox2label" class="contact_form_label" name="textbox2label" for="username">Username:</label>
