...
<body>
    ...
    <!-- <?php
    //if(!empty($data)){?>
        <span id="error" class="errorMessage"></span><?php //var_dump($data); ?>
        <?php //}
        ?> -->
...
$sqla =$conn->prepare("SELECT * FROM tbl_comment WHERE comment_status='Approved' AND product_id= $product_id ORDER BY comment_id desc");
